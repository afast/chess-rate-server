...
#
### BEGIN INIT INFO
# Provides:          chess-rate-server
# Required-Start:    $remote_fs $syslog
# Required-Stop:     $remote_fs $syslog
# Default-Start:     2 3 4 5
# Default-Stop:      0 1 6
# Short-Description: Start chess-rate-server app at boot time.
# Description:       Enable service provided by chess-rate-server.
### END INIT INFO
#

PATH=/usr/local/sbin:/usr/local/bin:/sbin:/bin:/usr/sbin:/usr/bin
NAME="chess-rate-server"
DAEMON=/usr/bin/$NAME
DESC=$NAME
